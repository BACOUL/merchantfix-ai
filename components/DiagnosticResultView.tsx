...
export function DiagnosticResultView({ analysis, correctedCsvResult }: DiagnosticResultViewProps) {
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-slate-50 p-5 md:p-6">
      <p className="text-xs font-black uppercase tracking-[0.22em] text-blue-700">MerchantFix.ai V1</p>
      <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">Diagnostic result</h2>
      ...
      <div className="mt-6 grid gap-5">
        ...
        {analysis.issues.some((issue) => issue.manualReviewRequired) ? (
          <section className="rounded-lg border border-amber-200 bg-amber-50 p-5 text-amber-950">
            <h3 className="text-lg font-black">Manual review required</h3>
        ...
        {correctedCsvResult?.correctedCsv ? (
          <section className="rounded-lg border border-emerald-200 bg-emerald-50 p-5">
            <h3 className="text-lg font-black text-emerald-950">Corrected CSV available</h3>
            ...
            <button
              ...
              className="mt-4 rounded-full bg-emerald-700 px-5 py-3 font-black text-white transition hover:bg-emerald-800"
            >
